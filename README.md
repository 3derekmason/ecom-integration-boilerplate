...
```sh
grep -rl 'ecom' ./ | xargs sed -i '' 's/ecom/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with ecom
...
Want to contribute? Ping us on `ecom` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
   ```
   example:
   git clone https://github.com/vuestorefront/ecom.git
   cd ecom
   ```
...
- [ecom integration Documentation](https://docs.vuestorefront.io/ecom)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `ecom` channel on [our Discord](discord.vuestorefront.io).
